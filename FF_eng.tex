...
\ecverasmus[3pt]{Oct 2016 - in progress}{Erasmus+ Internship}{ServiceNow, UK}{Knowledge of the ServiceNow product through System Administration, Scripting, Discovery, Application Creation classes and internal projects in the Training department.}{Dr. Raffaele Manfellotto}
...
\ecvitem[10pt]{ServiceNow projects}{
	\begin{itemize}
		\item[\color{curious-blue}\tiny$\blacksquare$] I have worked on two applications for the training department coordinators integrating the Google Maps and Timezone API using UI Page, developing a tree-relationship structure for Location table, ACL design and lab test results data integration between students' and instructor's instances.   
	\end{itemize}
}
